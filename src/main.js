import {generateOffersList, generateWaypoint} from './mock/waypoint';
...
const offersListModel = new OffersListModel();
offersListModel.offers = generateOffersList();

const tripMainElement = document.querySelector('.trip-main');
const tripNavigationElement = tripMainElement.querySelector('.trip-controls__navigation');
const tripFiltersElement = tripMainElement.querySelector('.trip-controls__filters');
const tripEventsElement = document.querySelector('.trip-events');
const eventsBoardPresenter = new EventsBoardPresenter(tripEventsElement, pointsModel, offersListModel);
